            ...
            <Table bordered>
              ...
              { data.map((prd, idx) => (
                    <tr key ={idx}>
                            ...
                            <td>
                                {prd.attributes.kategori}
                            </td>
                            
                            <td>
                                <div className="d-flex justify-content-between">
                                    
                                    <Link href={`/admin/mahasiswa-gql/updatemahasiswa?id=${prd.id}&kode_agen=${prd.attributes.kode_agen}&nama=${prd.attributes.nama}&angkatan=${prd.attributes.angkatan}&nomor_hp=${prd.attributes.nomor_hp}`}
                                    >
                                        <a>Edit</a>
                                    </Link>
                                    ...
                                    <button 
                                        ...
                                        value = {prd.kode_agen}
                                        onClick={(e)=>hapusMahasiswaGql(prd.id, prd.attributes.kode_agen)}
                                    >
                                            Hapus
                                    </button>
                                </div>
